...
public class CSEvaluateDialog extends AlertDialog {
    ...
    public void showStarMessage(boolean resolvedOption) {
        ...
        final RatingBar ratingBar = (RatingBar) findViewById(R.id.rc_rating_bar);
        final TextView evaluateLevel = (TextView) findViewById(R.id.rc_evaluate_level);
        final TextView isResolved = (TextView) findViewById(R.id.rc_cs_resolved_or_not);
        final LinearLayout progressLayout = (LinearLayout) findViewById(R.id.rc_resolve_progress);
        final ImageView resolvedBtn = (ImageView) findViewById(R.id.rc_cs_resolved);
        final ImageView resolvingBtn = (ImageView) findViewById(R.id.rc_cs_resolving);
        final ImageView unresolvedBtn = (ImageView) findViewById(R.id.rc_cs_unresolved);
        final EditText edit = (EditText) findViewById(R.id.rc_cs_evaluate_content);
        final ImageView closeBtn = (ImageView) findViewById(R.id.rc_close_button);
        final TextView submitBtn = (TextView) findViewById(R.id.rc_submit_button);
